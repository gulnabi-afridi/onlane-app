...
const CarDetailHeader = ({ header }) => {
  return (
    <div className='min-w-[1030px] overflow-auto grid min-h-[36px] bg-white-dark rounded-[4px] px-3 grid-cols-[.2fr,.7fr,1fr,.5fr,.5fr,.5fr,1fr,1fr,.6fr,1.3fr,1fr,20px] justify-center items-center'>
